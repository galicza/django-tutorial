...
class QuestionIndexDetailTests(TestCase):
    ...
    # This is no good since the detail doesn't have the question text, but the choices in it...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of question with a pub_date in the past should return the question's text.
        """
